...
/*
 * Vendored from https://github.com/alex85k/wingetopt src/getopt.h,
 * commit 98ea94f3d77890678da28230aa156b225cc14974, kept diff-minimal
 * against upstream (see commit history for the local changes).
 */
